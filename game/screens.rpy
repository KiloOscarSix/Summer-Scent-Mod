...
init -1 style tracker:
    properties gui.text_properties("tracker")
...
init -501 screen tracker():

    style_prefix "tracker"

    if ( sis_affection > 0 or sis_submission > 0 or sf_affection > 0 or sf_dominance > 0 ) and persistent.tracking == True:
        frame:
            id "tracker"
            style "tracker"

            background Image("gui/trackerBackground.png")
            ...
            if sis_affection > 0:
                ...
                text _("[sis_name] Affection : {i}{color=#007BA7}[sis_affection]{/color}{/i}") size 24
            if sis_submission > 0:
                text "[sis_name] Submission : {i}{color=#007BA7}[sis_submission]{/color}{/i}" size 24
            if sf_affection > 0:
                text "[sf_name] Affection : {i}{color=#007BA7}[sf_affection]{/color}{/i}" size 24
            if sf_dominance > 0:
                text "[sf_name] Dominance : {i}{color=#007BA7}[sf_dominance]{/color}{/i}" size 24


init -1 python:
    config.overlay_screens.append("tracker")
...
init -1 style window:
    ...
    background Image("gui/textbox_210.png", xalign=0.5, yalign=1.0)
...
init -1 style choice_button is default:
    background Image("gui/choice_idle.png")
    hover_background Image("gui/choice_hover.png")
...
init -1 style quick_button:
    ...
    background Image("gui/mm_idle.png", yalign=1.0)

    hover_background Image("gui/mm_hover.png", yalign=1.0)
...
init -501 screen navigation():
    ...
    vbox:
        ...
        if main_menu or _in_replay:
            textbutton "Oscar's Gallery" action [ui.callsinnewcontext("galleryNameChange"), ShowMenu("sceneGalleryMenu")]
...
init -1 style navigation_button:
    ...
    idle_background Image("gui/mt_button_idle.png")
    hover_background Image("gui/mt_button_hover.png")
...
init -501 screen main_menu():
    ...
    imagebutton:
        idle "gui/substar_btn_idle.png"
        hover "gui/substar_btn_hover.png"
        action OpenURL("https://subscribestar.adult/thenaughtycaptain")
        xalign 0.0
        ypos 762


    imagebutton:
        idle "gui/pat_btn_idle.png"
        hover "gui/pat_btn_hover.png"
        action OpenURL("https://www.patreon.com/TheNaughtyCaptain")
        xalign 0.0
        ypos 866
    ...
    imagebutton:
        idle "gui/tnc_btn_idle.png"
        hover "gui/tnc_btn_hover.png"
        action OpenURL("http://www.thenaughtycaptain.com/")
        xalign 0.0
        ypos 970
...
init -501 screen credits():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("{color=#007BA7}{b}Thank you.{/b}{/color}\n")





            text _("The development of this game can be supported through {a=https://www.patreon.com/TheNaughtyCaptain}Patreon{/a} or {a=https://subscribestar.adult/thenaughtycaptain}SubscribeStar{/a}.\nEvery one of my supporters is a reason to continue working on Summer Scent.\nI can't thank you enough.\n")
            text _("\n{u}My level 3 supporters :{/u}\n")
            text _("Droftaw, gamersglory, DarkJaanan, Alex, MynameJeffcykadebil, operator, rancidtunafish, Jeff Marsiglio, Kehli, unyonz, Thomas, Mark Fraser, TBP12, BlindMunky, Cole Ferrell, mikaberza, Chris Smith, Lucas DeMon, Scott Thomas, FRANK, Yfg882, Public Joe, Oliver Dächert, Christian Zach, Justaman, Brayden Davis, flanby, Theodor Aspgren, Michael Logan, Davlamin Carter, Pietro, Andrew Tait, nordic_paladin, beautytysyaaaa")
            text _("\n\nSpecial thanks to Recyclik for his help in proofreading my broken English.")



define -1 gui.credits = ""


init -1 style credits_label is gui_label
init -1 style credits_label_text is gui_label_text
init -1 style credits_text is gui_text
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        action [FileAction(slot), SetVariable("save_name", "")]
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Tracker")
                    textbutton _("Display tracker") action ToggleVariable("persistent.tracking", True, False)
